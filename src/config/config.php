...
return [
    ...
    */
    ...
    'repository_template_path' => 'vendor/way/generators/src/Way/Generators/templates/repository.txt',
    ...
    |
    */
    'model_target_path'   => app_path('bibliotecaunsm/Entity'),

    'repository_target_path'   => app_path('bibliotecaunsm/Repository'),
